/**
 * Página de Inicialización de Mensajería - FincAirbnb
 * 
 * Página para inicializar conversaciones desde alugamentos existentes
 */
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          ...
          <h1 className="text-3xl font-bold text-gray-900 mb-2">
            Inicialización de Mensaxería
          </h1>
          <p className="text-gray-600">
            Esta ferramenta crea conversacións automáticamente desde os teus alugamentos existentes.
          </p>
        </div>
          ...
          <CardContent className="space-y-6">
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
              ...
              <ul className="text-sm text-blue-800 space-y-1">
                <li>• Busca todos os teus alugamentos existentes</li>
                <li>• Crea unha conversación para cada alugamento que non teña unha</li>
                <li>• Xera unha mensaxe inicial automática</li>
                <li>• Conecta o sistema de mensaxería cos alugamentos</li>
              </ul>
            </div>
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-sm text-gray-600">
                  Preme o botón para crear conversacións desde os teus alugamentos.
                </p>
              </div>
