...
│   └── D:/Webs/FincAirbnb_backend  # Express + MongoDB backend
│
...
3. **Project structure**: `/ESTRUCTURA_PROYECTO.md` - Understand frontend repo + external backend organization
...
- **v0.1.0** (October 2025) - Initial documentation structure
